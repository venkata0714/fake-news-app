...
CMD ["sh", "-c", "streamlit run app.py --server.port=8501 --server.address=0.0.0.0 & sleep 5 && ngrok http 8501 --authtoken 2xrv3USJiIwB4XjqbIDWYhtxYT8_2XFcUXgWoYejthqwfN1th --log=stdout"]
